...
Desenvolvido por:
    ...
    Instagram: @_.kser._
    3º Período de Ciência da Computação - Puc Minas
*/
...
int main()
{
    ...
    char *cred1 = "Desenvolvido por Julio Cesar Gonzaga Ferreira Silva";
    char *cred2 = "Aluno da Puc Minas - Ciencia da Computacao";
    char *cred3 = "Terceiro periodo / 2024";
    char *cred4 = "Instagram: @_.kser._";
    char *cred5 = "Linkedin: linkedin.com/in/kserjc";


    char *var1 = "Jogo Snake em C";
    char *var2 = "Copyright: Julio Cesar";
    char *var3 = " Good Luck!";
    ...
    textcolor(7);
     printf("\n\n                                              ");
    textcolor(7);
    ImprimirSlowMotionChar(cred4);
    printf("\n\n                                              ");
    textcolor(10);
    ImprimirSlowMotionChar(cred5);
    textcolor(7);
    printf("\n\n");
